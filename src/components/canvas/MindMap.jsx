...
const MindMap = () => {
    ...
    return (
        <div className=" text-xl border-2 border-red-500 text-black tracking-wider flex justify-center items-center min-h-screen p-4
      before:bg-no-repeat
      before:-z-10">
            <main id="mindmap" ref={mindMapRef} className="relative w-full max-w-2xl border-blue-500 border h-96 
        [&_.item]:rounded-2xl
        [&_.item]:border-b-2
        [&_.item]:absolute
        [&_.item]:w-fit
        ...
        [&_.item]:shadow-lg">
                <div scale-up className="[--order:1] item bg-white !rounded-2xl !py-4 !px-6 top-2/4 -translate-y-2/4 left-2/4 -translate-x-2/4 !border-none" data-clr="#F59E0B">
                    ...
                    <div scale-up data-clr="#22C55E" className="[--order:3] item bg-green-100 border-green-500 max-[600px]:top-32 max-[600px]:left-0 -top-24 -left-20">
                        <p>Productivity</p>
                    </div>
                    <div scale-up data-clr="#EF4444" className="[--order:4] item bg-red-100 border-red-500 max-[600px]:top-32 max-[600px]:left-12 top-24 -left-56">
                        <p>Automation</p>
                    </div>
                    ...
                    <div scale-up data-clr="#3B82F6" className="[--order:6] item bg-gray-100 border-gray-500 max-[600px]:top-72 max-[600px]:left-0 top-40 -right-40">
                        <p>Backflip</p>
                    </div>
                </div>
            </main>
